            ...
            <div class="list_c">
                <ul class="cate_list">
                    <c:forEach items="${productList}" var="temp">
                        <li>
                            <div class="img">
                                <a href="${ctx}/productdeatil?action=queryProductDeatil&id=${temp.id}" target="_blank">
                            ...
                            <div class="name"><a href="${ctx}/productdeatil?action=queryProductDeatil&id=${temp.id}">${temp.name}</a></div>
                            <div class="carbg">
