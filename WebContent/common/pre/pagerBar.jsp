...
<div class="pages">
 <%--   <c:if test="${pager.pageCount>=1}">
    ...
    <c:if test="${pager.pageCount==0}">
     ...
     <div class="fanye">[${pager.pageNum} / ${pager.pages}]
                 <a href="${ctx}/${pageurl.url}?page=${pager.firstPage}">首页</a> 
               
                  
                <a href="${ctx}/${pageurl.url}?page=${pager.prePage} ">上一页</a> 
                 <a href="${ctx}/${pageurl.url}?page=${pager.nextPage} ">下一页</a> 
        
                <a href="${ctx}/${pageurl.url}?page=${pager.lastPage}">尾页</a></div> 
