...
function settlement3(){
    ...
    $.ajax({
        ...
        success: function (jsonStr) {
        	...
        	alert(result.data.serialnumber);
        	if(result.code==0){
        		
        		
        		location.href=contextPath+"/pre/settlement/settlement3.jsp?currentOrder="+;
                
         		$("#settlement").html(result.data);
